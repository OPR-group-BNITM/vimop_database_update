...
# Downloads
id_refseq_download=$(submit_job rs_setup downloads)
id_virus_taxinfo=$(submit_job virus_taxinfo downloads)
id_virus_sequences=$(submit_job virus_sequences downloads "$id_virus_taxinfo")
id_rvdb=$(submit_job rvdb downloads)
id_merge_ncbi_rvdb_covid=$(submit_job merge_ncbi_rvdb_covid downloads "$id_virus_sequences" "$id_rvdb")
id_rna=$(submit_job rna downloads)
id_contaminants=$(submit_job contaminants downloads)
...
id_centrifuge_db=$(submit_job centrifuge build_centrifuge_index "$id_virus_db" "$id_refseq_download")
